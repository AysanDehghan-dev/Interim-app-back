...
user_register_model = api.model(
    "UserRegister",
    {
        "firstName": fields.String(
            required=True, description="User first name", example="Jean"
        ),
        "lastName": fields.String(
            required=True, description="User last name", example="Dupont"
        ),
        "email": fields.String(
            required=True, description="User email", example="jean.dupont@example.com"
        ),
        "password": fields.String(
            required=True, description="Password (min 6 chars)", example="password123"
        ),
        "confirmPassword": fields.String(
            required=True, description="Confirm password", example="password123"
        ),
...
company_register_model = api.model(
    "CompanyRegister",
    {
        "name": fields.String(
            required=True, description="Company name", example="TechCorp"
        ),
        "industry": fields.String(
            required=True, description="Company industry", example="Technology"
        ),
        ...
        "email": fields.String(
            required=True, description="Company email", example="contact@techcorp.com"
        ),
        "password": fields.String(
            required=True, description="Password (min 6 chars)", example="password123"
        ),
        ...
        "website": fields.String(
            description="Company website", example="https://techcorp.com"
        ),
...
salary_model = api.model(
    ...
    {
        "min": fields.Integer(
            required=True, description="Minimum salary", example=40000
        ),
        "max": fields.Integer(
            required=True, description="Maximum salary", example=55000
        ),
...
job_create_model = api.model(
    ...
    {
        "title": fields.String(
            required=True, description="Job title", example="Frontend Developer"
        ),
        "description": fields.String(
            required=True,
        ...
        "location": fields.String(
            required=True, description="Job location", example="Lyon, France"
        ),
        "type": fields.String(
            required=True,
...
job_application_model = api.model(
    "JobApplication",
    {
...
experience_model = api.model(
    "Experience",
    {
        ...
        "startDate": fields.DateTime(
            required=True, description="Start date", example="2020-01-01T00:00:00Z"
        ),
        "endDate": fields.DateTime(
            description="End date", example="2022-12-31T00:00:00Z"
        ),
        "current": fields.Boolean(description="Currently working", example=False),
        "description": fields.String(
            description="Job description",
            example="Developed web applications using React...",
        ),
    },
)

education_model = api.model(
    "Education",
    {
        "institution": fields.String(
            required=True, description="Institution name", example="University of Lyon"
        ),
        "degree": fields.String(required=True, description="Degree", example="Master"),
        "field": fields.String(
            required=True, description="Field of study", example="Computer Science"
        ),
        "startDate": fields.DateTime(
            required=True, description="Start date", example="2015-09-01T00:00:00Z"
        ),
        "endDate": fields.DateTime(
            description="End date", example="2020-06-30T00:00:00Z"
        ),
        "current": fields.Boolean(description="Currently studying", example=False),
        "description": fields.String(
            description="Description", example="Specialized in web development..."
        ),
    },
)
