from app.utils.db import insert_one, find_one, update_one, find_by_id, find_many, count_documents
...
class Job:
    ...
    def create(job_data):
        ...
        if 'company_id' in job_data and not isinstance(job_data['company_id'], ObjectId):
