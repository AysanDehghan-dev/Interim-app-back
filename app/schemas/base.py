...
from marshmallow import Schema, fields, ValidationError as MarshmallowValidationError, pre_dump, post_load
...
class EnumField(fields.Field):
    ...
    def _deserialize(self, value, attr, data, **kwargs):
        ...
        if not self.enum_class.is_valid(value):
            ...
            raise MarshmallowValidationError(f"Invalid value. Must be one of: {valid_values}")
        return value
...
class PhoneField(fields.Field):
    ...
    def _deserialize(self, value, attr, data, **kwargs):
        ...
        if len(digits_only) < 10:
            raise MarshmallowValidationError("Phone number must have at least 10 digits")
