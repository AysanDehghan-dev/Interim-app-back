...
||||||| parent of 2c0145b (feat: Add database management scripts and improve configuration)
    try:
        ...
        # Return user data and token
        return jsonify({"user": UserSchema().dump(user), "token": token}), 201
...
||||||| parent of 2c0145b (feat: Add database management scripts and improve configuration)
    try:
        ...
        # Return company data and token
        return jsonify({"company": CompanySchema().dump(company), "token": token}), 201
...
||||||| parent of 2c0145b (feat: Add database management scripts and improve configuration)
    try:
        ...
        # Return company data and token
        return jsonify({"company": CompanySchema().dump(company), "token": token}), 200
